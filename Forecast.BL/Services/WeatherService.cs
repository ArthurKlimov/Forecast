        ...
        private string GetIconPathCorrespondsToCode(int weatherCode)
        {
            switch (weatherCode)
            {
                case 119: case 122: case 143:
                    {
                        return "/images/weather-icons/119.png";
                    }
                case 116:
                    {
                        return "/images/weather-icons/116.png";
                    }
                case 113:
                    {
                        return "/images/weather-icons/113.png";
                    }
                case 350:
                    {
                        return "/images/weather-icons/350.png";
                    }
                case 182: case 185:
                    {
                        return "/images/weather-icons/182.png";
                    }
                case 227: case 230: case 248: case 260:
                    {
                        return "/images/weather-icons/227.png";
                    }
                case 176: case 263: case 266: case 281: 
                case 293: case 296: case 311: case 317:
                case 320: 
                    {
                        return "/images/weather-icons/176.png";
                    }
                case 284: case 299: case 302: case 305: 
                case 308: case 314:
                    {
                        return "/images/weather-icons/284.png";
                    }
                case 179: case 323: case 326: case 329:
                case 332: case 335:  case 338: case 368:
                case 371:
                    {
                        return "/images/weather-icons/179.png";
                    }
                case 353: case 356: case 359: case 362:
                case 374: case 377:
                    {
                        return "/images/weather-icons/353.png";
                    }
                case 200: case 386: case 389: case 392:
                case 395:
                    {
                        return "/images/weather-icons/200.png";
                    }
                default:
                    {
                        return string.Empty;
